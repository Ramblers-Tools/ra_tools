 ...
 * @since  2.0
 */
class EmailModel extends ItemModel {
    ...
    protected function populateState() {
        ...
        if ((!$user->authorise('core.edit.state', 'com_ra_tools')) && (!$user->authorise('core.edit', 'com_ra_tools'))) {
    ...
    public function getItem($id = null) {
        if ($this->_item === null) {
            ...
            if ($table && $table->load($id)) {
                ...
                if ($published = $this->getState('filter.published')) {
                    if (isset($table->state) && $table->state != $published) {
                        throw new \Exception(Text::_('COM_RA_TOOLS_ITEM_NOT_LOADED'), 403);
                    }
                }
            ...
            if (empty($this->_item)) {
                throw new \Exception(Text::_('COM_RA_TOOLS_ITEM_NOT_LOADED'), 404);
            }
        }
    ...
    public function getItemIdByAlias($alias) {
        ...
        if (method_exists($this, 'getAliasFieldNameByView')) {
            $aliasKey = $this->getAliasFieldNameByView('email');
        }
