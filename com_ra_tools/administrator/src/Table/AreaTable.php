...
class AreaTable extends Table implements VersionableTableInterface, TaggableTableInterface {
    ...
    public function __construct(DatabaseDriver $db) {
        $this->typeAlias = 'com_ra_tools.area';
    ...
    public function bind($array, $ignore = '') {
        ...
        if (!$user->authorise('core.admin', 'com_ra_tools.area.' . $array['id'])) {
            $actions = Access::getActionsFromFile(
                            JPATH_ADMINISTRATOR . '/components/com_ra_tools/access.xml',
                            "/access/section[@name='area']/"
            );
            $default_actions = Access::getAssetRules('com_ra_tools.area.' . $array['id'])->getData();
            $array_jaccess = array();
