    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_ra_events') || $user->authorise('core.edit.state', 'com_ra_events')) {
            ...
            if (!$item) {
                ...
                $this->setRedirect(Route::_('index.php?option=com_ra_events&view=profiles', false));
            } else {
    ...
    public function checkin() {
        ...
        if ($user->authorise('core.manage', 'com_ra_events') || $item->checked_out == $user->id) {
            ...
            if ($return === false) {
                ...
                $this->setRedirect(Route::_('index.php?option=com_ra_events&view=profile' . '&id=' . $id, false), $message, 'error');
                return false;
            } else {
                // Checkin succeeded.
                $message = Text::_('COM_RA_EVENTS_CHECKEDIN_SUCCESSFULLY');
                $this->setRedirect(Route::_('index.php?option=com_ra_events&view=profile' . '&id=' . $id, false), $message);
                return true;
            }
        } else {
    ...
    public function remove() {
        ...
        if ($user->authorise('core.delete', 'com_ra_events')) {
            ...
            if ($return === false) {
                ...
                $this->app->redirect(Route::_('index.php?option=com_ra_events&view=profiles', false));
            }
