...
class ClusterModel extends AdminModel
{
	 ...
	 * @since  3.4.8
	 */
	public $typeAlias = 'com_ra_tools.cluster';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_ra_tools.edit.cluster.data', array());
	...
	/**
	 * Method to duplicate an Cluster
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__ra_clusters');
				$max             = $db->loadResult();
