...
{
	/**
	 * Method to clone existing Nations
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_ra_tools&view=nations');
	}
	 ...
	 * @since   3.0.0
	 */
	public function getModel($name = 'Nation', $prefix = 'Administrator', $config = array())
	{
